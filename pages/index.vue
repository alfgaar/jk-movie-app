...
export default {
  ...
  head() {
    return {
      title: 'Movie App - Latest Streamming Movie Info',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Get all the latest streamming movies in theaters & online',
        },
        {
          hid: 'keywords',
          name: 'keywords',
          content: 'movies, stream, streamming, theaters, online',
        },
      ]
    }
  },
  methods: {
    async getMovies() {
      // apikey: https://api.themoviedb.org/3/movie/550?api_key=e103e9773f15c74459d2a07dbe23d73c
